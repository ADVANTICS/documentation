...
- [Advantics Generic PEV protocol v2.5 (Kayak format, latest)](charge-controllers/evcc_generic/Advantics_Generic_PEV_protocol_v2.5.kcd ':ignore')
...
- [Advantics Generic PEV protocol v2.5 (DBC format)](charge-controllers/evcc_generic/Advantics_Generic_PEV_protocol_v2.5.dbc ':ignore')
