...
* DC contactors drivers embedded in the controller directly (see [DC contactors](../configuration/dc_contactors.md) config)
* A supported CAN sensor, that Advantics can directly provide you (see [CAN sensor](../configuration/can_sensor.md) config)
...
!!! attention
    The same disclaimers than in [No BMS mode](../configuration/no_bms.md) section apply. Use this only for quick
