...
<div class="noheader-table compact-table" markdown="1">
...
This product incorporates open source software components.
...
[provided here in the `THIRD_PARTY_NOTICES.txt` file](THIRD_PARTY_NOTICES.txt).
