...
CHAdeMO charging cables vary to a much greater degree, mostly because of different ways of solenoid control and different temperature sensing technology. Often, CHAdeMO cable wiring has labeled pins as 1-10 (see CHAdeMO pinout). The solenoid is not shown on this diagram.


{{ figure('assets/Description-of-the-CHAdeMO-connector-pinout-and-schematic.jpg', 'CHAdeMO connector pinout and schematic', size='1000px') }}
