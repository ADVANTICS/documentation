...
{{ figure('../assets/ADB-PC-DC01 9.jpg', 'Physical view of the ADB-PC-DC01 power converter') }}
...
{{ figure('../assets/ac01_dc01_mcs_example.webp', 'MCS charger system architecture using DC01 and AC01 modules') }}
