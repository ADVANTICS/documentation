...
!!! warning
    Take close attention to the -m switch. You must use the correct firmware for the correct module. Otherwise you risk to damage the module.

!!! warning
    Do not disconnect or turn off the module power supply while the flashing process is taking process or permanent damage to the module might occur.
...
!!! note
    The Git revision/build date are information about the bootloader itself, NOT the module firmware.
