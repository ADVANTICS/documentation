...
In this example, the ADM-PC-LL25 is used in the PFC Voltage control mode. As explained in [Control modes](7_Firmware_Overview.md#control-modes), the module will command to the upstream PFC a certain input voltage, extending the operating range and improving the efficiency of the converter.


![3phase charging](assets/app_3phase_charger2.svg){ width="100%" }
...
![3phase charging](assets/diagrams-BPUD_500V-1000V.svg){ width="100%" }
