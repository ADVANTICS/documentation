...
Up to 800V DC bus and 500V output operation is possible. For more details on the specifications, please check the [ADM-PC-LL25 specifications](specifications.md).
...
To operate the LLC, use the 'Voltage control' mode. For more information, please refer to the [Control Modes](can_bus_interface.md#LLC_Mode_Control) subsection.
...
To operate the LLC with the Advantics combo, use the 'PPFC Voltage control' mode. For more information, please refer to the [Control Modes](can_bus_interface.md#LLC_Mode_Control) subsection.
...
!!! tip
    Refer to [Application examples](application_examples.md) to see typical circuit applications and connection diagrams.
