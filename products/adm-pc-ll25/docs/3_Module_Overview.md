...
Please see the [Specifications](5_Mechanical_and_Electrical_Technical_Overview.md) section for ADM-PC-LL25 for electrical and mechanical details.

## Communication protocol

Please see the [CAN protocol in Advantics products](can_bus_overview.md) section for details on the communication interface of the module.
