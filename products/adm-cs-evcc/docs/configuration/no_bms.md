...
this voltage, charge will be cut-off immediately. This is different from entry [max_voltage](generalities.md#max_voltage) as
...
The amount of current used will correspond to entry [max_current](generalities.md#max_current). Use a reasonably low value.
