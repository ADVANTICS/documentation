---
title: ADM-CS-EVCC — Vehicle-side CCS Charge Controller
description: Vehicle-side CCS Charge Controller — product overview and technical data
---

<div style="text-align: center; margin: 3rem 0;">
  <h1 style="color: #00A99D; font-size: 2.5rem; margin-bottom: 1rem;">ADM-CS-EVCC</h1>
  <h2 style="color: #1a1a1a; font-size: 1.6rem; margin-bottom: 0.5rem;">Vehicle-side CCS Charge Controller</h2>
  <p style="font-size: 1.05rem; color: #666; max-width: 72ch; margin: 0.5rem auto;">
    PLC to CAN gateway EVCC. Supports CCS (V2G), AC, and NACS protocols. Equipped for harsh environments.
  </p>
  <div style="margin-top: 1.5rem;">
    <img src="assets/EVCC.png" alt="ADM-CS-EVCC" style="max-width: 720px; width: 100%; height: auto;">
  </div>
</div>
...
|--------------|-----------|
| **Product** | ADM-CS-EVCC |
| **Description** | Vehicle-side CCS Charge Controller |
