...
The ADB-PC-AC01 requires liquid cooling with the following specifications:
...
The ADB-PC-AC01 supports multiple mounting configurations:
...
| **Parameter** | **Requirement** | **Notes** |
|---------------|-----------------|-----------|
| **Cable Type** | 3-phase + PE | No neutral required |
| **Current Rating** | ≥150A per phase | Continuous operation |
| **Voltage Rating** | ≥600V | Suitable for 480V systems |
| **Temperature Rating** | ≥90°C | Insulation rating |
| **Conduit** | Appropriate for environment | IP rating maintained |

#### AC Installation Procedure

1. **Cable Preparation**
   - Select appropriate cable gauge
   - Route cables to module location
   - Prepare cable ends with proper terminations

2. **AC Connection**
   - Ensure all power sources are disconnected
   - Connect PE ground conductor first
   - Connect phase conductors to appropriate connectors
...
2. **Electrical Verification**
   ...
   - Verify phase rotation and polarity
