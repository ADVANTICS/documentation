...
Find the ADM-PC-LF45 CAN bus .kcd file here: [**ADM_PC_LF45.kcd**](assets/ADM_PC_LF45.kcd)
...
Find the ADM-PC-LF45 CAN bus .dbc file here: [**ADM_PC_LF45.dbc**](assets/ADM_PC_LF45.dbc)
...
![CAN_address](assets/CAN_address_space.png){ width="60%" }
...
![Device type and stack position tree](assets/ID_type_stackPosition_master.png){ width="60%" }
...
![Device type and stack position tree](assets/protocol_regions.png){ width="60%" }
