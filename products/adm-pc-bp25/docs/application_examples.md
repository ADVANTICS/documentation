...
A basic 30 kW 3-phase charger, using ADM-PC-LF46 as a filter stage and inrush limiter, ADM-PC-BP25 as a Power Factor Correction stage, and the ADM-PC-LL25 as a unidirectional isolated DC/DC converter.

![3phase charging](assets/app_3phase_charger.svg){ width="200%" }
<figcaption style="text-align: center">3-phase unidireecdtional EV charger</figcaption>

## 3-phase bidirectional charger
An advanced 3-phase fully bidirectional charger, capable of charging vehicles with 30 kW power, and exporting power back to the AC supply. This configuration consists of ADM-PC-LF46 as a filter stage and inrush limiter, ADM-PC-BP25 as a Power Factor Correction stage, followed by ADM-PC-BI25, an isolated bidirectional DC/DC. The last stage is another ADM-PC-BP25, this time connected as a bidirectional Buck, regulating the 1000 V DC bus of the isolated DC/DC down to required voltage and current for EV charging/discharging.

![3phase bidir charging](assets/app_3phase_bidir_charger.svg){ width="200%" }
...
![Bidirectional buck](assets/app_bidir_buck.svg){ width="70%" }
...
![Bidirectional boost buck](assets/app_bidir_boost_buck.svg){ width="200%" }
...
![150kW Bidirectional buck](assets/app_150kw_bidir_buck.svg){ width="70%" }
...
![portable inverter charger](assets/app_portable_inverter_charger.svg){ width="90%" }
