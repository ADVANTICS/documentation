...
For specific information about the message, please check the [CAN database](can_bus_interface.md) section.
...
For more information about possible applications, please refer to the [Application Examples](application_examples.md) section.
