        ...
        <ul>
          <li><strong>pev-controller 2.3.0 / ccs-evcc 2.4.0</strong>
            <ul>
              ...
              <li>Report CE and ID state via new message <a href="vehicle-can-interfaces/can_v2.html#mcs_extra_information">MCS_Extra_Information</a> (informational only)</li>
