---
title: ADM-CS-MEVC — MCS Charge Controller EVCC
description: MCS Charge Controller EVCC — product overview and technical data
---

<div style="text-align: center; margin: 3rem 0;">
  <h1 style="color: #00A99D; font-size: 2.5rem; margin-bottom: 1rem;">ADM-CS-MEVC</h1>
  <h2 style="color: #1a1a1a; font-size: 1.6rem; margin-bottom: 0.5rem;">MCS Charge Controller EVCC</h2>
  <p style="font-size: 1.05rem; color: #666; max-width: 72ch; margin: 0.5rem auto;">
    The First MCS ready EVCC for heavy-duty, mining, and marine applications equipped for harsh environments.
  </p>
  <div style="margin-top: 1.5rem;">
    <img src="assets/MEVC.png" alt="ADM-CS-MEVC" style="max-width: 720px; width: 100%; height: auto;">
  </div>
</div>
...
|--------------|-----------|
| **Product** | ADM-CS-MEVC |
| **Description** | MCS Charge Controller EVCC |
