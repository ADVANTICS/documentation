...
sed -i 's/(#No BMS mode)/(charge-controllers\/evcc_configuration\/no_bms.md)/' can.md
sed -i 's/(#CAN sensor)/(charge-controllers\/evcc_configuration\/can_sensor.md)/' can.md
