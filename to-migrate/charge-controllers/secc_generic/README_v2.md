...
# Generic SECC CAN interface version 2
...
1. [Charge sequence diagram](charge-controllers/secc_generic/appendix-a.md)
1. [Changelog](charge-controllers/secc_generic/changelog.md)
